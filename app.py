...
if option=="Basic Information":
    ...
    selected_task= st.selectbox("Choose on Tasks",["Add New Product","Product History","Place Reorder","Receive Reorder"])
...
#----------------------RECEIVING AS ORDER----------------
        ...
        # fetch orders ion Ordered Stage
